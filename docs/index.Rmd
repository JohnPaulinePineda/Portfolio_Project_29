...
|
| **[A]** Numeric variables which demonstrated differential relationships with the <span style="color: #FF0000">ttodead</span> and <span style="color: #FF0000">died</span> survival time and event status variables include:
...
|
| **[B]** Factor variables which demonstrated differential relationships with the <span style="color: #FF0000">ttodead</span> and <span style="color: #FF0000">died</span> survival time and event status variables include:
...
|      **[B.4]** <span style="color: #FF0000">insulin</span> variable (factor)
|
...
# # for all variables
# ##################################
# MA_CIN <- peakVO2.Source[,!names(peakVO2) %in% c("dilver","nifed")]
# 
# ##################################
...
# # for all variables
# ##################################
# MA_BSC <- peakVO2.Source[,!names(peakVO2) %in% c("dilver","nifed")]
# 
# ##################################
# # Initializing data containers
# # and random seed
