...
|      **[D.1]** RSF = 0.70227
|      **[D.2]** CPH = 0.69820
|      **[D.3]** The range of cross-validated BSC metrics was relatively higher for the RSF model as compared to CPH model.
|
...
# for all variables
##################################
MA_IBSC <- peakVO2.Source[,!names(peakVO2) %in% c("dilver","nifed")]
