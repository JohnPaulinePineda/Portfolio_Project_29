...
# for all variables
##################################
MA_CIN <- peakVO2.Source[,names(peakVO2.Source) %in% c("ttodead","died","interval","insulin")]
...
# for all variables
##################################
MA_BSC <- peakVO2.Source[,names(peakVO2.Source) %in% c("ttodead","died","interval","insulin")]
