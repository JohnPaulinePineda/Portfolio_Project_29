...
|
| **[C]** To simplify the subsequent computations, only a single numeric (which demonstrated the best correlation with survival time and consistency of distribution) and a single factor variable (which demonstrated the lowest Log-Rank Test p-value and sufficient separation in the estimated Kaplan-Meier survival curve) were evaluated during survival modelling which include:
|      **[C.1]** <span style="color: #FF0000">interval</span> variable (factor)
|      **[C.2]** <span style="color: #FF0000">insulin</span> variable (factor)
|
...
|
| **[D]** The average split-sample cross-validated CIN based on 5 iterations  are summarized as follows: :
|      **[D.1]** RSF = 0.63738
|      **[D.2]** CPH = 0.66629
...
|
| **[A]** Details <span style="color: #FF0000">Variable</span> using the <mark style="background-color: #CCECFF">**SurvMetrics**</mark> package.  
|      **[A.1]** <span style="color: #FF0000">parameter</span> = details.
|
...
|
| [MAE](https://cn.bing.com/) is the average of the differences between the predicted time values and the actual observation time values, by only considering samples for which the event occurs.
|
| **[A]** Details <span style="color: #FF0000">Variable</span> using the <mark style="background-color: #CCECFF">**SurvMetrics**</mark> package.  
|      **[A.1]** <span style="color: #FF0000">parameter</span> = details.
|
